...
#s = Service()
# print(json.dumps(s.get_user_vote('0xCasddedeasdadaddaddaddad'), indent=4))
# print(json.dumps(s.get_curated_services(), indent=4))
# print(json.dumps(s.get_profile_details('0xCasddedeasdadaddaddaddad'), indent=4))
#print(json.dumps(s.get_service_status(None), indent=4))
#print(json.dumps(s.get_service_status([1,2,4,51,'asdad']), indent=4))
